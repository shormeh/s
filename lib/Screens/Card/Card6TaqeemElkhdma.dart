...
class _Card6TaqeemElkhdmaState extends State<Card6TaqeemElkhdma> {
        ...
        body: Container(
          ...
          child: ListView(
            children: [
              ...
              Center(child: Text(translate('lan.branchRate'),style: TextStyle(
              ...
              Center(child: Text(translate('lan.foodRate'),style: TextStyle(
                  color: HomePage.colorGreen,
                  fontWeight: FontWeight.bold,
                  fontSize: 16
              ),)),
              ...
              Center(child: Text( translate('lan.priceRate')+'..',style: TextStyle(
                  color: HomePage.colorGreen,
                  fontWeight: FontWeight.bold,
                  fontSize: 16
              ),)),
  ...
  void senToRate() async {
    ...
    var response = await http.post("${HomePage.URL}rate/vendor", headers: {
