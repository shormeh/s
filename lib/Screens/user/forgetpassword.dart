...
import 'package:shormeh/Screens/user/Verify.dart';
...
class _ForgetPasswordState extends State<ForgetPassword> {
  ...
  Future sendDataToServer(BuildContext context) async {
    var response = await http.post("${HomePage.URL}auth/forget-password",
        headers: {
    ...
    if (datauser['success']=="1") {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context)=>VerfySignup(phone: phoneCtrl.text,)));
